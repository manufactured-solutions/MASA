...
{
  // MANUAL FIX (based on comparison of about O(11,000) characters in term Q_e for 3D between whats coded and one in  https://svn.ices.utexas.edu/repos/pecos/mms/analytical/comp_navier_stokes/latex/MMS_NavierStokes_Equation_3d.pdf at revision 12826) -- sahni  // THIS ONLY WORKS FOR L=1
