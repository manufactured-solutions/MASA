...
extern "C" double masa_eval_grad_1d_u    (double x){return(masa_eval_grad_1d_u<double>  (x));};
extern "C" double masa_eval_grad_1d_p    (double x){return(masa_eval_grad_1d_p<double>  (x));};
extern "C" double masa_eval_grad_1d_rho  (double x){return(masa_eval_grad_1d_rho<double>(x));};
...
extern "C" double masa_eval_grad_2d_u   (double x,double y,int i){return(masa_eval_grad_2d_u<double>  (x,y,i));};
extern "C" double masa_eval_grad_2d_v   (double x,double y,int i){return(masa_eval_grad_2d_v<double>  (x,y,i));};
extern "C" double masa_eval_grad_2d_w   (double x,double y,int i){return(masa_eval_grad_2d_w<double>  (x,y,i));};
extern "C" double masa_eval_grad_2d_p   (double x,double y,int i){return(masa_eval_grad_2d_p<double>  (x,y,i));};
extern "C" double masa_eval_grad_2d_rho (double x,double y,int i){return(masa_eval_grad_2d_rho<double>(x,y,i));};
...
extern "C" double masa_eval_grad_3d_u   (double x,double y,double z,int i){return(masa_eval_grad_3d_u  <double>(x,y,z,i));};
extern "C" double masa_eval_grad_3d_v   (double x,double y,double z,int i){return(masa_eval_grad_3d_v  <double>(x,y,z,i));};
extern "C" double masa_eval_grad_3d_w   (double x,double y,double z,int i){return(masa_eval_grad_3d_w  <double>(x,y,z,i));};
extern "C" double masa_eval_grad_3d_p   (double x,double y,double z,int i){return(masa_eval_grad_3d_p  <double>(x,y,z,i));};
extern "C" double masa_eval_grad_3d_rho (double x,double y,double z,int i){return(masa_eval_grad_3d_rho<double>(x,y,z,i));};
