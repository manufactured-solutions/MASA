...
int main(void)
{
  ...
  masa_set_param("a_rhox", 2.0);
  masa_set_param("a_rhoy", 4.0);
  masa_set_param("a_rhoz", 6.0);
  masa_set_param("a_ux", 2.0);
  masa_set_param("a_uy", 4.0);
  masa_set_param("a_uz", 6.0);
  masa_set_param("a_vx", 4.0);
  masa_set_param("a_vy", 2.0);
  masa_set_param("a_vz", 6.0);
  masa_set_param("a_wx", 6.0);
  masa_set_param("a_wy", 4.0);
  masa_set_param("a_wz", 2.0);
