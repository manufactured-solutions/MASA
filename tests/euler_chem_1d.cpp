...
{
  Scalar pi = acos(-1);
  Scalar T_an = T_0 + T_x * cosl(a_Tx * pi * x / L);
  return T_an;
}
...
{  
  Scalar pi = acos(-1);
  Scalar rho_an = rho_N_0 + rho_N_x * sin(a_rho_N_x * pi * x / L) + rho_N2_0 + rho_N2_x * cosl(a_rho_N2_x * pi * x / L);
  return rho_an;
}
...
{
  Scalar pi = acos(-1);
  Scalar rho_an_N2 = rho_N2_0 + rho_N2_x * cosl(a_rho_N2_x * pi * x / L);
  return rho_an_N2;
}
