  ...
  Scalar L)
{
  ...
  Q_e = -a_px * pi * p_x * Gamma * U * sin(a_px * pi * x / L) / (Gamma - Scalar(0.1e1)) / L + a_py * pi * p_y * Gamma * V * cos(a_py * pi * y / L) / (Gamma - Scalar(0.1e1)) / L - a_pz * pi * p_z * Gamma * W * sin(a_pz * pi * z / L) / (Gamma - Scalar(0.1e1)) / L + (U * U + V * V + W * W) * a_rhox * pi * rho_x * U * cos(a_rhox * pi * x / L) / L / Scalar(0.2e1) - (U * U + V * V + W * W) * a_rhoy * pi * rho_y * V * sin(a_rhoy * pi * y / L) / L / Scalar(0.2e1) + (U * U + V * V + W * W) * a_rhoz * pi * rho_z * W * cos(a_rhoz * pi * z / L) / L / Scalar(0.2e1) - (Scalar(-0.3e1) * a_ux * u_x * cos(a_ux * pi * x / L) - a_vy * v_y * cos(a_vy * pi * y / L) + a_wz * w_z * sin(a_wz * pi * z / L)) * pi * RHO * U * U / L / Scalar(0.2e1) - (a_uy * u_y * sin(a_uy * pi * y / L) + a_vx * v_x * sin(a_vx * pi * x / L)) * pi * RHO * U * V / L - (a_uz * u_z * sin(a_uz * pi * z / L) - a_wx * w_x * cos(a_wx * pi * x / L)) * pi * RHO * U * W / L - (-a_ux * u_x * cos(a_ux * pi * x / L) - Scalar(0.3e1) * a_vy * v_y * cos(a_vy * pi * y / L) + a_wz * w_z * sin(a_wz * pi * z / L)) * pi * RHO * V * V / L / Scalar(0.2e1) + (a_vz * v_z * cos(a_vz * pi * z / L) + a_wy * w_y * cos(a_wy * pi * y / L)) * pi * RHO * V * W / L - (-a_ux * u_x * cos(a_ux * pi * x / L) - a_vy * v_y * cos(a_vy * pi * y / L) + Scalar(0.3e1) * a_wz * w_z * sin(a_wz * pi * z / L)) * pi * RHO * W * W / L / Scalar(0.2e1) - (-a_ux * u_x * cos(a_ux * pi * x / L) - a_vy * v_y * cos(a_vy * pi * y / L) + a_wz * w_z * sin(a_wz * pi * z / L)) * pi * Gamma * P / (Gamma - Scalar(0.1e1)) / L;
  ...
  Scalar L)
{
  ...
  Q_v = a_rhox * pi * rho_x * U * V * cos(a_rhox * pi * x / L) / L - a_rhoy * pi * rho_y * V * V * sin(a_rhoy * pi * y / L) / L + a_rhoz * pi * rho_z * V * W * cos(a_rhoz * pi * z / L) / L - a_vx * pi * v_x * RHO * U * sin(a_vx * pi * x / L) / L + a_vz * pi * v_z * RHO * W * cos(a_vz * pi * z / L) / L + a_py * pi * p_y * cos(a_py * pi * y / L) / L + (a_ux * u_x * cos(a_ux * pi * x / L) + Scalar(0.2e1) * a_vy * v_y * cos(a_vy * pi * y / L) - a_wz * w_z * sin(a_wz * pi * z / L)) * pi * RHO * V / L;
  ...
  Scalar L)
{
  ...
  Q_w = a_rhox * pi * rho_x * U * W * cos(a_rhox * pi * x / L) / L - a_rhoy * pi * rho_y * V * W * sin(a_rhoy * pi * y / L) / L + a_rhoz * pi * rho_z * W * W * cos(a_rhoz * pi * z / L) / L + a_wx * pi * w_x * RHO * U * cos(a_wx * pi * x / L) / L + a_wy * pi * w_y * RHO * V * cos(a_wy * pi * y / L) / L - a_pz * pi * p_z * sin(a_pz * pi * z / L) / L + (a_ux * u_x * cos(a_ux * pi * x / L) + a_vy * v_y * cos(a_vy * pi * y / L) - Scalar(0.2e1) * a_wz * w_z * sin(a_wz * pi * z / L)) * pi * RHO * W / L;
