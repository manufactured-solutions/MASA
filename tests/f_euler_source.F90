...
module euler_source_interface
  ...
  interface
     real (c_double) function eval_3d_u_source(x,y,u_0,u_x,u_y,v_0,v_x,v_y,rho_0,rho_x,rho_y,&
     ...
     real (c_double) function eval_3d_v_source(x,y,u_0,u_x,u_y,v_0,v_x,v_y, &
     ...
     real (c_double) function eval_3d_rho_source(x,y,u_0,u_x,u_y,v_0,v_x,v_y, &
     ...
     real (c_double) function eval_3d_e_source(x,y,u_0,u_x,u_y,v_0,v_x,v_y, &
     ...
     real (c_double) function eval_3d_p_an(x,y,p_0,p_x,p_y,a_px,a_py,L) bind (C)
       use iso_c_binding
       implicit none
     ...
     real (c_double) function eval_3d_u_an(x,y,u_0,u_x,u_y,a_ux,a_uy,L) bind (C)
       use iso_c_binding
       implicit none
     ...
     real (c_double) function eval_3d_v_an(x,y,v_0,v_x,v_y,a_vx,a_vy,L) bind (C)
       use iso_c_binding
       implicit none
     ...
     real (c_double) function eval_3d_rho_an(x,y,rho_0,rho_x,rho_y,a_rhox,a_rhoy,L) bind (C)
       use iso_c_binding
       implicit none
