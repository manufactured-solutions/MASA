...
program main
  ...
  do i=0, nx
	...
	exact_rho = masa_eval_2d_exact_rho    (x,y)
        ...
        ufield2 = eval_2d_source_u  (x,y,u_0,u_x,u_y,v_0,v_x,v_y, &
             rho_0,rho_x,rho_y,p_0,p_x,p_y,a_px,a_py, &
             a_rhox,a_rhoy,a_ux,a_uy,a_vx,a_vy,L)

	vfield2 = eval_2d_source_v  (x,y,u_0,u_x,u_y,v_0,v_x,v_y, &
             rho_0,rho_x,rho_y,p_0,p_x,p_y,a_px,a_py, &
             a_rhox,a_rhoy,a_ux,a_uy,a_vx,a_vy,L)

        rho2    = eval_2d_source_rho(x,y,u_0,u_x,u_y,v_0,v_x,v_y, &
             rho_0,rho_x,rho_y,p_0,p_x,p_y,a_px,a_py, &
             a_rhox,a_rhoy,a_ux,a_uy,a_vx,a_vy,L)

        efield2  = eval_2d_source_e(x,y,u_0,u_x,u_y,v_0,v_x,v_y, &
             rho_0,rho_x,rho_y,p_0,p_x,p_y,a_px,a_py, &
