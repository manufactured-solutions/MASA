  ...
  do i=0, nx
     do j=0, ny
        do k=0, nz
           ...
           ! check against maple
           ufield2 = eval_3d_u_source  (%val(x),%val(y),%val(z),%val(u_0),%val(u_x),%val(u_y),%val(u_z),%val(v_0),%val(v_x),%val(v_y), &
                ...
                %val(a_ux),%val(a_uy),%val(a_uz),%val(a_vx),%val(a_vy),%val(a_vz),%val(a_wx),%val(a_wy),%val(a_wz),%val(L))

           vfield2 = eval_3d_v_source  (%val(x),%val(y),%val(z),%val(u_0),%val(u_x),%val(u_y),%val(u_z),%val(v_0),%val(v_x),%val(v_y), &
                %val(v_z),%val(w_0),%val(w_x),%val(w_y),%val(w_z), &
                %val(rho_0),%val(rho_x),%val(rho_y),%val(rho_z),%val(p_0),%val(p_x),%val(p_y),%val(p_z), &
                %val(a_px),%val(a_py),%val(a_pz),%val(a_rhox),%val(a_rhoy),%val(a_rhoz),&
                %val(a_ux),%val(a_uy),%val(a_uz),%val(a_vx),%val(a_vy),%val(a_vz),%val(a_wx),%val(a_wy),%val(a_wz),%val(L))

           wfield2 = eval_3d_w_source  (%val(x),%val(y),%val(z),%val(u_0),%val(u_x),%val(u_y),%val(u_z),%val(v_0),%val(v_x),%val(v_y), &
                %val(v_z),%val(w_0),%val(w_x),%val(w_y),%val(w_z), &
                %val(rho_0),%val(rho_x),%val(rho_y),%val(rho_z),%val(p_0),%val(p_x),%val(p_y),%val(p_z), &
                %val(a_px),%val(a_py),%val(a_pz),%val(a_rhox),%val(a_rhoy),%val(a_rhoz),&
                %val(a_ux),%val(a_uy),%val(a_uz),%val(a_vx),%val(a_vy),%val(a_vz),%val(a_wx),%val(a_wy),%val(a_wz),%val(L))

           rho2    = eval_3d_rho_source(%val(x),%val(y),%val(z),%val(u_0),%val(u_x),%val(u_y),%val(u_z),%val(v_0),%val(v_x),%val(v_y), &
                %val(v_z),%val(w_0),%val(w_x),%val(w_y),%val(w_z), &
                %val(rho_0),%val(rho_x),%val(rho_y),%val(rho_z),%val(p_0),%val(p_x),%val(p_y),%val(p_z), &
                %val(a_px),%val(a_py),%val(a_pz),%val(a_rhox),%val(a_rhoy),%val(a_rhoz),&
                %val(a_ux),%val(a_uy),%val(a_uz),%val(a_vx),%val(a_vy),%val(a_vz),%val(a_wx),%val(a_wy),%val(a_wz),%val(mu),%val(L))
           ...
           u_an2   = eval_3d_u_an  (%val(x),%val(y),%val(z),%val(u_0),%val(u_x),%val(u_y),%val(u_z),%val(a_ux),%val(a_uy),%val(a_uz),%val(L))
           v_an2   = eval_3d_v_an  (%val(x),%val(y),%val(z),%val(v_0),%val(v_x),%val(v_y),%val(v_z),%val(a_vx),%val(a_vy),%val(a_vz),%val(L))
           w_an2   = eval_3d_w_an  (%val(x),%val(y),%val(z),%val(w_0),%val(w_x),%val(w_y),%val(w_z),%val(a_wx),%val(a_wy),%val(a_wz),%val(L))
           rho_an2 = eval_3d_rho_an(%val(x),%val(y),%val(z),%val(rho_0),%val(rho_x),%val(rho_y),%val(rho_z),%val(a_rhox),%val(a_rhoy),%val(a_rhoz),%val(L))
           p_an2   = eval_3d_p_an  (%val(x),%val(y),%val(z),%val(p_0),%val(p_x),%val(p_y),%val(p_z),%val(a_px),%val(a_py),%val(a_pz),%val(L))
